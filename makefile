...
SHARED := src/console.cpp \
	src/buffers/producers/ti_producer.cpp src/word_source_file.cpp \
	src/word_source_group.cpp src/word_source_file_group.cpp src/buffers/producers/sentence_producer.cpp \
	src/pht_model.cpp src/buffers/sen_buffer.cpp src/buffers/readers/sen_buffer.cpp \
	src/sgd_trainer.cpp src/buffers/tc_buffer.cpp src/buffers/readers/tc_buffer.cpp  \
